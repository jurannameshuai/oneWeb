...
$pageview = pager();
if(isset($_GET['catid'])){
    $cat['title']= str_replace('DD',$GLOBALS['area_list'][$_GET['catid']]['areaname'],$cat['title']);
    $cat['keywords']= str_replace('DD',$GLOBALS['area_list'][$_GET['catid']]['areaname'],$cat['keywords']);
    $cat['description']= str_replace('DD',$GLOBALS['area_list'][$_GET['catid']]['areaname'],$cat['description']);
}else{
    $cat['title']= str_replace('DD',$mymps_global['SiteCity'],$cat['title']);
    $cat['keywords']= str_replace('DD',$mymps_global['SiteCity'],$cat['keywords']);
    $cat['description']= str_replace('DD',$mymps_global['SiteCity'],$cat['description']);
}
