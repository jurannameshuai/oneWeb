...
if(isset($_GET['catid'])){
    $dd=$GLOBALS['area_list'][$_GET['catid']]['areaname'];
}else{
    $dd=$mymps_global['SiteCity'];
}
$cat['title']= str_replace('DD',$dd,$cat['title']);
$cat['keywords']= str_replace('DD',$dd,$cat['keywords']);
$cat['description']= str_replace('DD',$dd,$cat['description']);
