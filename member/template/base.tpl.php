                                ...
                                <div class="pbody">
                                    ...
                                    <div class="formgroup">
                                        ...
                                        <div class="formrow">
                                            ...
                                            <div class="form-enter">
                                                <input type="text" name="cname" class="text" value="<?php echo $row['cname']; ?>" <? if($row['per_certify'] == 1) echo 'readonly';?>/> <?php if($row['per_certify'] == 1){?><font style="font-size:10px!important; color:red">通过身份认证后，不能再修改</font><?php }?>
                                            </div>
                                        </div>
...
<input type="text" class="text" name="mobile" value="<?php echo $row['mobile']?>" maxlength="" />
                                            </div>
                                            <div class="form-note">如：13888888888<?php echo $mymps_global[cfg_member_verify] == 4 ? '(不可更改)' : '';?></div>
...
<input type="text" class="text" name="tel" value="<?php echo $row['tel']?>" maxlength="" /> <label for="istel"><input type="checkbox" name="istel" value="1" id="istel">同步更新全部信息的联系电话</label>
                                            </div>
                                            <div class="form-note">前面为区号,如: 0592-1111111</div>
