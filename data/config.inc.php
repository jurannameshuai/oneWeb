...
$mymps_mymps['cfg_focus_limit']['portal']['index']['width']='655';
$mymps_mymps['cfg_focus_limit']['portal']['index']['height']='346';

$mymps_mymps['cfg_focus_limit']['classic']['index']['width']='655';
$mymps_mymps['cfg_focus_limit']['classic']['index']['height']='346';

$mymps_mymps['cfg_focus_limit']['simple']['index']['width']='655';
$mymps_mymps['cfg_focus_limit']['simple']['index']['height']='346';

$mymps_mymps['cfg_focus_limit']['news']['width']='333';
$mymps_mymps['cfg_focus_limit']['news']['height']='226';

$mymps_mymps['cfg_hdp_limit']['width']='640';//手机幻灯片宽度
$mymps_mymps['cfg_hdp_limit']['height']='110';//手机幻灯片高度
...
$mymps_mymps['cfg_banner_limit']['width'] = '1200';
$mymps_mymps['cfg_banner_limit']['height'] = '100';
?>