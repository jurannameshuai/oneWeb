...
<span class="lfaceimg"><a href='<?=$mymps_global['SiteUrl']?><?=$mymps['uri']?>' target='_blank'><img src='<? if(!$mymps['img_path']) { ?><?=$mymps_global['SiteUrl']?>/images/nophoto.gif<?php } else { ?><?=$mymps_global['SiteUrl']?><?=$mymps['img_path']?><?php } ?>' title='<?=$mymps['title']?>' align='absmiddle'></a> </span>
<span class="ltitlevalue"><a href="<?=$mymps_global['SiteUrl']?><?=$mymps['uri']?>" target="_blank" style="<? if($mymps['ifred'] == 1) { ?>color:red;<?php } ?> <? if($mymps['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>" title="<?=$mymps['title']?>"><? echo cutstr($mymps['title'],44); ?></a><? if($mymps['img_count']) { ?><span class="img_count"><?=$mymps['img_count']?>图</span><?php } if($mymps['info_level'] == 2) { ?><span class="tuijian">推荐</span><?php } if($mymps['certify'] == 1) { ?><span class="certify">认证</span><?php } ?>&nbsp;<br /><font style="font-size:12px; color:#808080"><? echo cutstr($mymps['content'],70); ?></font><br />
