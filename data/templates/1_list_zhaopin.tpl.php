...
<span class="ltitle">
<a href="<?=$mymps_global['SiteUrl']?><?=$mymps['uri']?>" target="_blank" style="<? if($mymps['ifred'] == 1) { ?>color:red;<?php } ?> <? if($mymps['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>" title="<?=$mymps['title']?>"><? echo cutstr($mymps['title'],18); ?></a>
        ...
        <div class="inforbox">
          ...
          <div class="tipsbox">
            ...
            <ul class="lists">
              <li> <span>薪资待遇：</span> <font color="#F70"><? if($mymps['day_salary']) { ?><?=$mymps['day_salary']?><?php } else { ?><?=$mymps['salary']?>元<?php } ?></font> </li>
              <li> <span>工作地点：</span> <?=$mymps['areaname']?> </li>
              <? if($mymps['work_life']) { ?><li> <span>工作经验：</span> <?=$mymps['work_life']?> </li><?php } ?>
...
<div class="footer_new">
    <div class="foot_new">
        ...
        <div class="foot_mobile">
            ...
            <? if($mymps_global['SiteEmail']) { ?><div class="h3">客服邮箱：<font><?=$mymps_global['SiteEmail']?></font></div><?php } ?>
            </ul>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="foot_powered">
    	Copyright &copy; <?=$mymps_global['SiteName']?>版权所有 <a href="http://www.miibeian.gov.cn"><?=$mymps_global['SiteBeian']?></a><font id="foots">Powered by <a href="http://www.mymps.com.cn"><?=MPS_SOFTNAME?></a> <a href="http://bbs.mymps.com.cn"><?=MPS_VERSION?></a></font><?=$mymps_global['SiteStat']?> <? if($cachetime) { ?>This page is cached at <? echo GetTime($timestamp,'Y-m-d H:i:s'); ?><?php } else { ?><font class="none_<?=$mymps_mymps['debuginfo']?>"><?php $mtime = explode(' ', microtime());$totaltime = number_format(($mtime['1'] + $mtime['0']-$mymps_starttime), 6); echo ' , Processed in '.$totaltime.' second(s) , '.$db->query_num.' queries'; ?></font><?php } ?>
    </div>
</div>
