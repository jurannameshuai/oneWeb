...
<td>
<input name="userid" id="reg_username" type="text" class="input input-large" require="true" datatype="userName|limit|ajax" url="<?=$mymps_global['SiteUrl']?>/javascript.php?part=chk_remember" min="4" max="20" msg="可输入字母、数字、下划线，不少于4个字符">&nbsp;
</td>
</tr>
<tr>
