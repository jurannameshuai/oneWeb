...
<div id="contactbar">
<a href="/" class="bottom_index<? echo $mod == 'index' ? '_on' : '';; ?>">首页</a>
<a href="<?=$mymps_global['mUrl']?>/index.php?mod=history" class="bottom_history<? echo $mod == 'history' ? '_on' : '';; ?>">历史</a>
<a href="<?=$mymps_global['mUrl']?>/index.php?mod=member" class="bottom_member<? echo in_array($mod,array('login','member','register','shoucang','mypost')) ? '_on' : '';; ?>">我的</a>
<a href="<?=$mymps_global['mUrl']?>/index.php?mod=post" class="bottom_post<? echo $mod == 'post' ? '_on' : '';; ?>">发布</a>
</div>
