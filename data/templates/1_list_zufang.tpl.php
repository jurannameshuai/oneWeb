...
<span class="lfaceimg"><a href='<?=$mymps_global['SiteUrl']?><?=$mymps['uri']?>' target='_blank'><img src='<? if(!$mymps['img_path']) { ?><?=$mymps_global['SiteUrl']?>/images/nophoto.gif<?php } else { ?><?=$mymps_global['SiteUrl']?><?=$mymps['img_path']?><?php } ?>' title='<?=$mymps['title']?>'></a></span>
