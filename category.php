...
//$pdetail = $mymps_global['SiteCity'] . $page_title_extra . ($cat['title'] ? $cat['title'] : $cat['catname']);
if($page_title_extra){
	$seo_tihuan=$page_title_extra;
}else{
    $seo_tihuan=$mymps_global['SiteCity'];
}
$pdetail =str_replace("DD",$seo_tihuan,($cat['title'] ? $cat['title'] : $cat['catname']));



$pdetail .= (1 < $page ? '-第' . $page . '页' : '');
$pdetail .= '_' . $mymps_global['SiteName'];
...
$cat['keywords'] =str_replace("DD",$seo_tihuan,($cat['keywords'] ? $cat['keywords'] : $cat['catname']));
$cat['description']=str_replace("DD",$seo_tihuan,($cat['description'] ? strip_tags($cat['description']) : $cat['catname']));
