...
{
	$option .= ($ifnone == false ? '<select id="catid" datatype="limit" require="true" msg="请选择所属分类" class=input name=catid>' : '<select id="catid" datatype="limit" require="true" msg="请选择所属分类" class=input name="catid[]">');
