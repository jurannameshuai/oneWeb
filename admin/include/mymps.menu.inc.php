...
$admin_menu[category][group][element]['地区管理']['地区分类']='area.php';
$admin_menu[category][group][element]['地区管理']['增加地区']='area.php?part=add';
$mymps_global['cfg_if_corp'] == 1 && $admin_menu[category][group][element]['商家分类']['商家分类']='corp.php';
$mymps_global['cfg_if_corp'] == 1 && $admin_menu[category][group][element]['商家分类']['增加分类']='corp.php?part=add';
...
$admin_menu[sitesys][group][element]['核心设置']['系统优化']='optimise.php';
...
if(is_array($data)){
	if($mymps_global['cfg_if_corp'] != 1){
		unset($data['优惠券'],$data['团购'],$data['商品']);
	}
