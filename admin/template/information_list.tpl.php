    ...
    <div class="mpstopic-category">
        <div class="panel-tab">
            <ul class="clearfix tab-list">
                ...
                <li><a title="正常信息" href="information.php?info_level=1" <?php if($info_level==1 || ($info_level=='' && $upgrade != 'index' && $upgrade != 'list' && $upgrade != 'category' && $ifred != '1' && $ifbold != '1')){?>class="current"<?php }?>>正常</a></li>
