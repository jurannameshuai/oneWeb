...
新增广告 -> 广告标题：<input style="vertical-align: middle" class="text" type="text" name="title" value="" size="25" maxlength="50">  <?=get_adv_style()?>
 <?=get_adv_option();?>
</form>
</td>
</tr>
...
<center>
<input type="submit" value="提 交" class="mymps large" name="<?php echo CURSCRIPT; ?>_submit"/>  
</center>
</form>
