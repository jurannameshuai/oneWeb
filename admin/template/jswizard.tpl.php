...
<tr>
<td width="45%" class="altbg1" ><b>所属地区:</b><br /><span class="smalltxt">设置允许参与信息调用的地区，可以按住 CTRL 多选，全选或全不选均为不做限制</span>
</td>
<td class="altbg2">
<select name="parameter[areaid][]" size="5" multiple="multiple">
<option value="">&nbsp;> 全部地区</option>
<option value="">&nbsp;</option>
<?=cat_list('area',0,$parameter['areaid'])?></select>
</td>
</tr>
