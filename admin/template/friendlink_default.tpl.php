    ...
    <div class="mpstopic-category">
        <div class="panel-tab">
            <ul class="clearfix tab-list">
                ...
                <li><a href="friendlink.php?do=type" <?php if($do=='type'){?>class="current"<?php }?>>网站类型管理</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="small-section">
	<a href="?"  <?php if(empty($ifindex) && empty($catid)) echo 'class="current"'; ?>>全部</a>
	<a href="friendlink.php?ifindex=2" <?php if($ifindex == 2) echo 'class="current"'; ?>>首页</a>
