...
网站首页幻灯片尺寸：<?=$mymps_mymps[cfg_focus_limit][$tpl_index[banmian]][index][width]?> * <?=$mymps_mymps[cfg_focus_limit][$tpl_index[banmian]][index][height]?><br />
新闻首页幻灯片尺寸：<?=$mymps_mymps[cfg_focus_limit][news][width]?> * <?=$mymps_mymps[cfg_focus_limit][news][height]?><br />
</td>
              </tr>
              <tr bgcolor="#f5fbff" >
                <td width="15%">图片顺序：</td>
            ...
            <tfoot>
              <tr bgcolor="#f5fbff" >
                <td height="45">&nbsp;</td>
                <td height="45">
                <input value="更 新" type="submit" class="mymps mini" name="<?php echo CURSCRIPT; ?>_submit">　
